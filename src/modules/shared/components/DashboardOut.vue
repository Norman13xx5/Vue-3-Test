  ...
  <header class="text-gray-700 body-font border-b border-gray-200">
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
      ...
      >
        ...
        <span class="ml-3 text-xl">BRACONSUMOS</span>
      </a>
    ...
    <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
      ...
      >
        <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">
          Manejo del framework Vue 3 <br class="hidden lg:inline-block" />Con Tailwind
        </h1>
        <p class="mb-8 leading-relaxed">
          Esto es una practica para mi repositorio personal el cual lo puedes encontrar como
          Norman13xx5 con le unico proposito de demostarle a los reclutadores mis diversas
          habilidades.
        </p>
      ...
      <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
        <img
          ...
          alt="hero"
          src="https://github.com/Norman13xx5.png"
        />
      </div>
    </div>
  </section>
        ...
        <div class="p-4 md:w-1/3">
          <div class="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
            <div class="flex items-center mb-3">
              ...
              <h2 class="text-gray-900 text-lg title-font font-medium">Pokemon</h2>
            </div>
            <div class="flex-grow">
              <p class="leading-relaxed text-base">
                Información acerca de los Pokemon de la serie animada Pokemon, aquí encontrará
                distiton Pokemon.
              </p>
              <button
                class="mt-3 text-indigo-500 inline-flex items-center"
                @click="redirect('history-home')"
              >
                Clic aquí
                <svg
                  fill="none"
        ...
        <div class="p-4 md:w-1/3">
          <div class="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
            <div class="flex items-center mb-3">
              ...
              <h2 class="text-gray-900 text-lg title-font font-medium">The Legend of Zelda</h2>
            </div>
            <div class="flex-grow">
              <p class="leading-relaxed text-base">
                Información acerca del videojuego The Legend of Zelda consumiendo un api genereica
    ...
    <div class="container px-5 py-24 mx-auto">
      <div class="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
        ...
        <p class="leading-relaxed text-lg">
          ...
          sold out gentrify plaid gastropub normcore XOXO 90's pickled cindigo jean shorts.
          Slow-carb next level shoindigoitch ethical authentic, yr scenester sriracha forage franzen
